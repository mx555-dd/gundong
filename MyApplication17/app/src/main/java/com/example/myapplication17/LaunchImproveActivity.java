...
import com.example.myapplication17.adapter.LaunchImproveAdapter;

public class LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.rongyao_w,
            R.drawable.shoubiao_w, R.drawable.yadi_w, R.drawable.yijia_w};
